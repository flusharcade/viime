// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LoginPage.cs" company="Flush Arcade Pty Ltd.">
...
namespace Viime.Pages
{
    ...
    /// Main page.
    /// </summary>
    public partial class LoginPage : ExtendedContentPage, INavigableXamarinFormsPage
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Camera.Pages.LoginPage"/> class.
        /// </summary>
        /// <param name="model">Model.</param>
        public LoginPage(LoginPageViewModel model) : base(model)
        {
        ...
        async void OnSignInSignOut(object sender, EventArgs e)
        {
            try
            {
                ...
                if (true)
                {
                    ...
                    (BindingContext as LoginPageViewModel)?.AuthFinished(ar != null);
