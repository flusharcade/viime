...
[assembly: Xamarin.Forms.ExportRenderer(typeof(Viime.Controls.CustomImage), 
                                        typeof(Viime.iOS.Renderers.CustomImage.CustomImageRenderer))]

namespace Viime.iOS.Renderers.CustomImage
{
	using System;
	...
	using Viime.iOS.Extensions;
	using Viime.iOS.Helpers;
